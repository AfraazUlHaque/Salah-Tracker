...
app.get('/api/history/analytics', async (req, res) => {
    try {
        ...
        // 🔥 FIX: Database se sirf namaz tracking records nikalie, chat messages ko ignore karein ($exists: false)
        const userHistory = await historyDB.find({ username: username, type: { $exists: false } });
...
app.get('/api/hadith', (req, res) => {
    ...
    { arabic: 'أ学رَبُ مَا يَكُونُ الْعَبْدُ مِنْ رَبِّهِ وَهُوَ سَاجِدٌ', text: 'The nearest a servant comes to his Lord is when he is prostrating (in Sujud).', source: 'Sahih Muslim 482' },
    ...
    { arabic: 'أَوَّلُ مَا يُحَاسَبُ بِهِ الْعَبْدُ يَوْمَ الْقِيَAMَةِ مِنْ عَمَلِهِ صَلاَتُهُ', text: 'The first thing for which a servant will be brought to account on the Day of Judgment will be his prayer.', source: 'Jami` at-Tirmidhi 413' },
    ...
    { arabic: 'ال...حَمْدُ لِلَّهِ تَمْلأُ الْمِيزَانَ', text: 'Praise be to Allah (Al-Hamdulillah) fills the scale of good deeds.', source: 'Sahih Muslim 223' },
    ...
    { arabic: 'مَنْ قَرَأَ حَرْفًا مِنْ كِتَابِ اللَّهِ فَلَهُ بِهِ حَسَنَةٌ', text: 'Whoever receives a single letter from the Book of Allah will receive one good deed, and ten like it.', source: 'Jami` at-Tirmidhi 2910' },
    ...
    { arabic: 'لاَ غِرَارَ فِي صَلاَةٍ وَلاَ تَسليمٍ', text: 'There should be no deception or delusion in prayer or in interactions.', source: 'Sunan Abi Dawud 929' },
    { arabic: 'الْقَبْرُ أَوَّلُ مَنZِلٍ مِنْ مَنَازِلِ الآخِرَةِ', text: 'The grave is the very first stage among the stages of the Hereafter.', source: 'Jami` at-Tirmidhi 2308' },
