...
const historyDB = Datastore.create({ filename: './history.db', autoload: true });
...
const BACKEND_PORT = 3040;
server.listen(BACKEND_PORT, () => {
    console.log(`====================================================`);
    console.log(` 🕌 PREMIUM AUTHENTICATED SERVER RUNNING ON PORT ${BACKEND_PORT}`);
    console.log(`====================================================`);
});